...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int x = 0; x < policyList.size(); x++) {
			...
			System.out.println("Policyholder's Height: " + policyList.get(x).getHolderHeight() + " inches");
			System.out.println();
			...
			System.out.println("Policyholder's BMI: " + ff.format(policyList.get(x)
					.bmiCalc(policyList.get(x).getHolderWeight(), policyList.get(x).getHolderHeight())));
			System.out.println();
